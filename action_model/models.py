...
class LabelEmbedder(nn.Module):
    ...
    """
    def __init__(self, in_size, hidden_size, dropout_prob=0.1, conditions_shape=(1, 1, 4096)):  # drop_0 cx new exp no learnable
        super().__init__()
